...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void GobackSignIn(){
        ...
        Intent backsignin = new Intent(RegisterActivity.this,LoginActivity.class);
    ...
    private void register(String fname, String lname, String email, String password) {
        class RegisterUser extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(RegisterActivity.this, "Please Wait"," Register processing ...", true, true);
            }
